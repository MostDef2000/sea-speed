...
- [x] T006 Verify branch freshness and exact changed-file scope against current `main`.
...
- [x] Exact branch scope is the approved five files and is not behind current `main`.
